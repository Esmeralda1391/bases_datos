...
<body>
    ...
    <section>
        ...
        <h2>Integrantes</h2>
        <ul>
            <li>Esmeralda Garces Rosas</li>
            <li>Humberto De La Cruz Domínguez</li>
            <li>Andrea Marlen Gutierrez Marquez</li>
        </ul>

        <h2>Consultas de cada integrante</h2>
        <ul>
            <li>Esmeralda</li>
            <ul>
                <li><a href="<?php echo base_url('posts/01') ?>">Consulta 1</a></li>
                <li><a href="<?php echo base_url('posts/02') ?>">Consulta 2</a></li>
                <li><a href="<?php echo base_url('posts/03') ?>">Consulta 3</a></li>
                <li><a href="<?php echo base_url('posts/04') ?>">Consulta 4</a></li>
            </ul>
            <li>Andrea Marlen</li>
            <ul>
                <li><a href="<?php echo base_url('posts/05') ?>">Consulta 5</a></li>
                <li><a href="<?php echo base_url('posts/06') ?>">Consulta 6</a></li>
                <li><a href="<?php echo base_url('posts/07') ?>">Consulta 7</a></li>
            </ul>
            <li>Humberto</li>
            <ul>
                <li><a href="<?php echo base_url('posts/08') ?>">Consulta 8</a></li>
                <li><a href="<?php echo base_url('posts/09') ?>">Consulta 9</a></li>
                <li><a href="<?php echo base_url('posts/10') ?>">Consulta 10</a></li>
            </ul>
        </ul>
